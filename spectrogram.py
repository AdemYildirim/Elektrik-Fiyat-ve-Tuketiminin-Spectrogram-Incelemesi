...
#saatlik fiyat verisinin spectrogramı
plt.plot(ptf2["price"].values)
plt.title('Saatlik Fiyat')  
plt.show()
plt.specgram(ptf2["price"].values,Fs=len(ptf2["price"])/24)
plt.title('Saatlik Fiyat Spectrogram')  
plt.show()

#günlük fiyat verisinin spectrogramı
ptf3 = ptf2.pivot_table("price","date-daily",aggfunc="mean")
plt.plot(ptf3["price"].values)
plt.title('Günlük Ort Fiyat')  
plt.show()
plt.specgram(ptf3["price"].values,Fs=1)
plt.title('Günlük Ort Fiyat Spectrogram')  
plt.show()

#aylık fiyat verisinin spectrogramı
ptf4 = ptf2.pivot_table("price","date-mounth",aggfunc="mean")
plt.plot(ptf4["price"].values)
plt.title('Aylık Ort Fiyat')  
plt.show()
plt.specgram(ptf4["price"].values,Fs=1)
plt.title('Günlük Ort Fiyat Spectrogram')  
plt.show()

#saatlik tüketim verisinin spectrogramı
plt.plot(consumptions["consumption"].values)
plt.title('Saatlik Tüketim')  
plt.show()
plt.specgram(consumptions["consumption"].values,Fs=len(consumptions["consumption"])/24)
plt.title('Saatlik Tüketim Spectrogram')  
plt.show()

#günlük tüketim verisinin spectrogramı
...
plt.show()
plt.specgram(consumptions2["consumption"].values,Fs=1)
plt.title('Günlük Ort Tüketim Spectrogram')  
plt.show()

#aylık tüketim verisinin spectrogramı
...
plt.show()
plt.specgram(consumptions3["consumption"].values,Fs=1)
plt.title('Aylık Ort Tüketim Spectrogram')  
plt.show()
...
autocorrelation_plot(ptf2["price"])
plt.show()
...
###################### pacf ler 
sm.graphics.tsaplots.plot_pacf(ptf2["price"],lags=7*24)
...
plt.show()
sm.graphics.tsaplots.plot_pacf(ptf3["price"],lags=7)
...
plt.show()
sm.graphics.tsaplots.plot_pacf(ptf4["price"],lags=12)
